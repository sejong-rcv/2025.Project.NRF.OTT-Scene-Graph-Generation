...
def run_eval(device='0', ckpt_path='exps/params/sgdet/temporal/checkpoint_3.pth'):
...
if __name__ == "__main__":
    device = '2'
    run_eval(device=device, ckpt_path='exps/params/sgdet/temporal/checkpoint_3.pth')
